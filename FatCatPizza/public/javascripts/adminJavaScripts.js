...
function updateVariables()
{
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            else if(currentview == 1) PastNotifications();
...
function createUserView()
{
    ...
    var i = 0;
    var out2 = "";
    out2 = '<ul class="nav navbar-nav navbar-right"><li class="active"><a href="#" data-toggle="modal" onclick="createUserView()">Create User</a></li><li><a href="#drinks" data-toggle="modal" onclick="TableNotifications()">Table Notifications</a></li><li><a href="#food" data-toggle="modal" onclick="PastNotifications()">Past Notifications</a></li><li><a href="#login" data-toggle="modal" onclick="ViewTables()">Tables</a></li></ul>';
    out += '<div class="container">';
    out += '<h3></h3>';
    out += '<h3></h3>';
    out += '<h3></h3>';
    out += '<div class="form-group">';
    out += '<label for="create-username" class="col-sm-2 control-label">Username</label>';
    out += '<div class="col-sm-10">';
    out += '<input type="username" required class="form-control" id="create-username" placeholder="username">';
    out += '</div>';
    out += '</div>';
    out += '<div class="form-group">';
    out += '<label for="create-password" class="col-sm-2 control-label">Password</label>';
    out += '<div class="col-sm-10">';
    out += '<input type="password" required class="form-control" id="create-password" placeholder="********">';
    out += '</div>';
    out += '</div>';
    out += '<div class="form-group">';
    out += '<label for="confirm-password" class="col-sm-2 control-label">Confirm Password</label>';
    out += '<div class="col-sm-10">';
    out += '<input type="password" required class="form-control" id="confirm-password" placeholder="********">';
    out += '</div>';
    out += '</div>';
    out += '<h3></h3>';

    out += '<div class="form-group" align="center">';
    out += '<a class="btn btn-default" onclick="createUser()">';
    out += 'create';
    out += '</a>';
    out += '</div>';
    out += '<h3></h3>';
...
function TableNotifications() {
    ...
    out2 = '<ul class="nav navbar-nav navbar-right"><li><a href="#" data-toggle="modal" onclick="createUserView()">Create User</a></li><li class="active"><a href="#drinks" data-toggle="modal" onclick="TableNotifications()">Table Notifications</a></li><li><a href="#food" data-toggle="modal" onclick="PastNotifications()">Past Notifications</a></li><li><a href="#login" data-toggle="modal" onclick="ViewTables()">Tables</a></li></ul>';
...
function PastNotifications() {
    ...
    var i = 0;
    var out2 = "";
    out2 = '<ul class="nav navbar-nav navbar-right"><li><a href="#" data-toggle="modal" onclick="createUserView()">Create User</a></li><li><a href="#drinks" data-toggle="modal" onclick="TableNotifications()">Table Notifications</a></li><li class="active"><a href="#food" data-toggle="modal" onclick="PastNotifications()">Past Notifications</a></li><li><a href="#login" data-toggle="modal" onclick="ViewTables()">Tables</a></li></ul>';
...
function ViewTables() {
    ...
    var out = "";
    var out2 = "";
    out2 = '<ul class="nav navbar-nav navbar-right"><li><a href="#" data-toggle="modal" onclick="createUserView()">Create User</a></li><li><a href="#drinks" data-toggle="modal" onclick="TableNotifications()">Table Notifications</a></li><li><a href="#food" data-toggle="modal" onclick="PastNotifications()">Past Notifications</a></li><li class="active"><a href="#login" data-toggle="modal" onclick="ViewTables()">Tables</a></li></ul>';
    ...
    for(i = 0; i < table_information.length; i++)
    {
        if(location == i)
        {
            ...
            for(j = 0; j < table_information[i].Customers.length; j++)
            {
                ...
                else if(table_information[i].Customers[j].Drink == "Water") drinkPrice = 0;
                else drinkPrice = 1;
